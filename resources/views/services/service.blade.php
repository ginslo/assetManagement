          			...
          			@endunless
          			 <p>{!! $service->description !!}</p>
								 ...
								 @if($category_slug == 'hosting')
									 <p><strong>Hosting Price:</strong> ${{ $service->price }} per month</p>
								 @else
									 <p><strong>Installation Price:</strong> ${{ $service->price }} (One Time)<br />
										 We can host this application for you. <a href="/services/hosting/">See hosting options</a></p>
									@endif
              @endforeach
            </div>
          </div>
