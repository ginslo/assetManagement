...
@section('content')
  <main>
      ...
      <p><span id="support">&nbsp;</span></p><p>  	<span class="title-caps-bold">Support</span></p>

      <p>  	  	Our&nbsp;  	<a target="_blank" href="https://westlinks.zendesk.com/hc/en-us" data-concrete5-link-type="image">helpdesk</a>, powered by&nbsp;Zendesk is set up to answer your questions and manage tickets should you need our assistance. <a target="_blank" href="https://westlinks.zendesk.com/hc/en-us/requests/new" data-concrete5-link-type="image">Submit a Ticket</a> (or just&nbsp;click the "Help" button below). You can also&nbsp;simply send an email to&nbsp;<a href="mailto:support@westlinks.com" data-concrete5-link-type="image">support@westlinks.com</a>.&nbsp;</p><p>  	Your satisfaction is guaranteed. Expect prompt service.</p>

      <p>  	<span id="feedback">&nbsp;</span>  </p>  <p>  	<span class="title-caps-bold">Feedback</span>  </p>
  ...
  <form enctype="multipart/form-data" class="form-stacked" id="miniSurveyView919" class="miniSurveyView" method="post" action="/index.php/contact/submit_form#1446018899">
  	...
  	<div class="fields">
  			...
  			<div><div><img src="/index.php/tools/required/captcha?nocache=1467123189" alt="Captcha Code" onclick="this.src = '/index.php/tools/required/captcha?nocache='+(new Date().getTime())" class="ccm-captcha-image" /></div><br/><div>Click the image to see another captcha.</div></div>
  ...
  <tr>
  	<td>
  		<p style="text-align: center;">
  			<span class="title-caps-bold">Text Chat</span>
  		</p>
  	</td>
  	<td>
  		<p style="text-align: center;">
  			<span class="title-caps-bold">Video Chat</span>
  		</p>
  	</td>
  </tr>
  <tr>
  	<td>
  		<p style="text-align: center;">
  			...
  			<!-- <a href="irc://irc.preinter.net:6669/westlinks">irc.preinter.net:6669/westlinks</a> -->
  		</p>
  		<p style="text-align: center;">
  			<strong>Google Hangouts</strong><br>
  			  			  	  	(support@westlinks.com)
  		</p>
      ...
      <g:hangout render="createhangout"
          invites="[{ id : '100057973526240014682', invite_type : 'PROFILE' }]">
      </g:hangout>
      </p>
  </div>

  <!--
  { id : 'support@westlinks.com', invite_type : 'EMAIL' }
  -->
      ...
      <p>  	<span id="call">&nbsp;</span></p><p>  <span class="title-caps-bold">Schedule a Call</span></p><p>  	  	  	  	Making spontaneous calls and schedule juggling can be a huge waste of valuable time, so please click the link below to choose a time from our calendar that works best for you. Just let us know what you would like to discuss. We look forward to hearing from you!</p><p>  	<a href="/contact/meeting-scheduler" data-concrete5-link-type="ajax"><strong>View Calendar Here</strong></a></p><p>  	<span class="title-caps-bold">SMS Text Message</span></p><p>  	<span>Send a text to +1 </span>855-712-1800 (NYC area: +1 929-325-1800). We will respond as quickly as possible.</p>

      <p>  	<span id="social">&nbsp;</span></p><p>  	<span class="title-caps-bold">Social Media</span></p>

      <p style="text-align: center;"><a href="https://twitter.com/westlinksOnline" data-concrete5-link-type="image"><strong>Twitter</strong></a></p><p style="text-align: center;"><a href="https://plus.google.com/+Westlinks/" data-concrete5-link-type="image"><strong>Google +</strong></a></p><p style="text-align: center;"><em><span style="color: rgb(191, 191, 191);"><span>Not on FB</span></span></em><br><a href="https://plus.google.com/+Westlinks/" data-concrete5-link-type="image"></a></p>
              </div>
          </div>
      </div>
